...
//   //start at begining and end of string, if those two match continue, if there is not a match, return the character at the start index
...
function palindromeIndex(s) {
  ...
  if (s === reverse(s)) {
    ...
    for (let i = 0; i < s.length; i++) {
      ...
      console.log(spliced)
      if (spliced === reverse(spliced)) return i
    }
  }
